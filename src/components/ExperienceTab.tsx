...
export default function ExperienceTab() {
  const items = [
    ...
    },
    {
      ...
      bullets: [
        'Engineered an assistive voice-driven navigation robotic system (VGRS: Voice-Guided Room Scout) for visually impaired individuals.',
        'Integrated multi-modal components including Speech-to-Text (STT), Text-to-Speech (TTS), and real-time Conversational AI engine.',
        'Programmed Arduino embedded microcontrollers and interfaces to reduce intent false-triggering, optimizing physical responses.',
      ],
      tags: ['Arduino', 'Speech-to-Text', 'Conversational AI', 'Embedded Hardware', 'Intent Recognition'],
    },
    {
      type: 'internship',
